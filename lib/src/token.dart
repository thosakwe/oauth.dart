...
class HmacSha1Tokens extends Tokens {
  ...
  List<int> _computeKey() {
    ...
    res.add($amp);
    if (userId != null) res.addAll(oauthEncode(userSecret));
    return res;
  }
...
BigInt _b64bigint(String str) {
  var s = _base64.decode(str).join();
...
class RsaSha1Tokens extends Tokens {
  ...
  factory RsaSha1Tokens(
      {String consumerId, String consumerKey, String userId, String userKey}) {
  ...
  RsaSha1Tokens.fromKeys(
      {String this.consumerId,
      RSAPublicKey this.consumerPublicKey,
      RSAPrivateKey this.consumerPrivateKey,
      String this.userId,
      RSAPublicKey this.userPublicKey,
      RSAPrivateKey this.userPrivateKey})
      : super.chain() {
  ...
  List<int> sign(List<int> body) {
    ...
    if (userPrivateKey != null) privateKey = userPrivateKey;
  ...
  bool verify(List<int> signature, List<int> body) {
    ...
    if (userPublicKey != null) publicKey = userPublicKey;
